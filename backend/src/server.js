...
// //     if (!connectionString) {
// //       throw new Error('❌ Variável de conexão MongoDB não definida (MONGO_URL/MONGO_URI)');
// //     }

// //     console.log(`⏳ Conectando ao MongoDB (Tentativa ${retryCount + 1}/${MAX_RETRIES})...`);
...
// //       // Configuração específica para ambiente Railway
...
// //     console.log(`📊 Status: ${mongoose.connection.readyState === 1 ? 'Pronto' : 'Instável'}`);
// //     retryCount = 0;
    
// //   } catch (err) {
// //     retryCount++;
// //     console.error(`❌ Falha na conexão (Tentativa ${retryCount}/${MAX_RETRIES}):`, err.message);
    
// //     if (retryCount < MAX_RETRIES) {
// //       console.log(`⏳ Nova tentativa em ${RETRY_DELAY/1000} segundos...`);
...
// //       console.error('2. Se o serviço MongoDB está ativo');
// //       console.error('3. Whitelist de IPs (se usando Atlas)');
// //       process.exit(1);
// //     }
// //   }
// // };
...
// //   console.log('🔁 Conexão reestabelecida com MongoDB');
// // });
...
// //     process.exit(0);
// //   } catch (err) {
// //     console.error('❌ Falha ao encerrar conexão:', err);
// //     process.exit(1);
// //   }
// // });
...
// // // Exporta a conexão e o mongoose
